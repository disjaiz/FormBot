...
const FolderDeleteModal = ({ isOpen, onClose, onConfirm , isLight}) => {
  ...
  return (
    <div className={styles.container}>
      <div className={styles.deleteModal} style={{backgroundColor: isLight ? 'white': '#090909'}}>
        <p className={styles.heading} style={{color: isLight && 'black'}}>Are you sure you want to delete the folder?</p>
