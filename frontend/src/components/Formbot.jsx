...
//       try {
//         const response = await fetch('http://localhost:3000/workspace/form', {
//           method: 'POST',
...
//         const data = await response.json();
//         if (data.success) {
//           return data.form; // Return form details
//         } else {
...
//       ? `http://localhost:3000/workspace/updateForm/${formId}`
//       : 'http://localhost:3000/workspace/saveForm';
...
//              <input type="text" id="name" name="name"  className={styles.formNameInput} placeholder='Enter Form Name' required   value={formName}
//                onChange={(e) => setFormName(e.target.value)}  style={{backgroundColor: isLight ? 'white': '#121212' , color: isLight? 'black': 'white', border: isLight ? '1px solid #c7c4c4' : '1px solid rgb(74, 71, 71)'}}/>
//          {/* =======================FLOW and RES modes======================================= */} 
